...
public class CommonMethods extends PageInitializer {
    ...
    //to get webdriver wait (explicit waits)
...
// this method will perform click operation but before perform click,
    //the method will wait for the element to be clickable
